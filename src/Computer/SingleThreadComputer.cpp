...
std::string ComputerSingleThread::printThreadMode(){
    return "SingleThread";
    //std::cout<< "SingleThread";
}
std::string ComputerSingleThreadNormal::printComputeMode(){
    return  "Normal";
    //std::cout<< "Normal";
}
std::string ComputerSingleThreadQuick::printComputeMode(){
    return  "Quick";
    //std::cout<< "Quick";
}
